(function () {
    ...
    var ICONS = {
        ...
        amazon:
            '<svg viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg">' +
            '<path d="M6 15.5c4.2 2.8 9.8 2.8 14 0 .6-.4 1.2.4.6.8-4.6 3.1-10.6 3.1-15.2 0-.6-.4 0-1.2.6-.8z"/>' +
            '<path d="M16.2 9.2a1.2 1.2 0 0 1 1.2-1.2h2.2a1.2 1.2 0 0 1 1.2 1.2v2.2a1.2 1.2 0 0 1-2.4 0v-.3l-2 1.2a1.2 1.2 0 0 1-1.2-2.1l2-1.2h-.8a1.2 1.2 0 0 1-1.2-1.2z"/>' +
            '</svg>',
