    ...
    function StudiosMain(object) {
        ...
        comp.create = function () {
            ...
            categories.forEach(function (cat, index) {
                ...
                pushParam(params, 'language', getLang());

                if (cat.params) {
                    for (var key in cat.params) {
                        if (!cat.params.hasOwnProperty(key)) continue;
                        pushParam(params, key, resolveValue(cat.params[key]));
                    }
                }
        ...
        function buildUrl(page) {
            ...
            if (object.params) {
                for (var key in object.params) {
                    ...
                    pushParam(params, key, resolveValue(object.params[key]));
                }
            }
    ...
    whenReady(function ($) {
        ...
        function addMenuButtons() {
            ...
            MENU_ORDER.forEach(function (sid) {
                ...
                var btn = $(
                    '<li class="menu__item selector" data-plugin="' + PLUGIN_NS + '" data-sid="' + sid + '">' +
